...
parser.add_argument("-r", "--min_remote_ratio", help="minimum remote ratio", type=float)
args = parser.parse_args()
MIN_REMOTE_RATIO = args.min_remote_ratio
print("min remote ration in caption.py: ", MIN_REMOTE_RATIO)
